  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          loading = false;
          error = 'تعذر تجهيز حساب المندوب (${e.code}).';
        });
      }
    } catch (_) {
      if (mounted) {
              ...
              child: Column(
                ...
                children: [
                  const CircleAvatar(
                    ...
                    child: Icon(Icons.delivery_dining_rounded, size: 42, color: Color(0xFF166534)),
                  ),
                  ...
                  Text(
                    register ? 'أنشئ حساب مندوب وأرسل طلبك للإدارة' : 'ادخل علشان تستقبل وتوصل الطلبات',
                    textAlign: TextAlign.center,
                  ...
                  FilledButton(
                    ...
                    child: Padding(
                      ...
                      child: loading
                          ...
                          : Text(register ? 'إنشاء حساب وإرسال الطلب' : 'تسجيل الدخول'),
                    ),
                  ),
                  TextButton(
                    onPressed: loading
                    ...
                    child: Text(register ? 'عندي حساب مندوب بالفعل' : 'إنشاء حساب مندوب جديد'),
                  ),
                  const SizedBox(height: 12),
                  const Text(
                    'الحساب الجديد يظل قيد المراجعة، ومش هيقدر يستلم طلبات قبل موافقة الإدارة.',
                    textAlign: TextAlign.center,

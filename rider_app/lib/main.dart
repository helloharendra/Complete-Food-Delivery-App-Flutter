...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    home: startupError == null ? const MySplashScreen() : RiderStartupError(error: startupError!),
  );
}
...
class RiderStartupError extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(body: SafeArea(child: Center(child: Padding(
    ...
    child: Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      const Text('تعذر تشغيل ديرب للمندوبين', textAlign: TextAlign.center, style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900)),

...
restaurentsDocumentsList=FirebaseFirestore.instance.collection("sellers")
...
.get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
      ...
      title: TextField(onChanged:(textEntered)
      {
...
initSearchingRestaurents(textEntered);
      ...
      decoration: InputDecoration(hintText: "Search Restaurent here...",
    ...
    body: FutureBuilder<QuerySnapshot>(future: restaurentsDocumentsList,builder:( context,snapshot){
      ...
      :Center(child: Text("No Recoord Found"),);
